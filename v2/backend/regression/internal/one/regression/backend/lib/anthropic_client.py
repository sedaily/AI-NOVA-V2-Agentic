...
def stream_anthropic_response(
    ...
    try:
        ...
        # 모델 ID 결정 (파라미터 > 기본값)
        selected_model = model_id if model_id else MODEL_ID
...
class AnthropicClient:
    ...
    def stream_response(
        ...
        try:
            ...
            logger.info(f"Streaming with Anthropic API (caching: {enable_caching}, model: {model_id})")
