# Regression (sedaily-column) Backend Deployment Script - PowerShell
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "   Regression Backend Deployment" -ForegroundColor Cyan
Write-Host "   Target: sedaily-column Lambda Functions" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan

$REGION = "us-east-1"
$BACKEND_DIR = "$PSScriptRoot\backend"
$TEMP_DIR = "$env:TEMP\lambda-deploy-regression"
