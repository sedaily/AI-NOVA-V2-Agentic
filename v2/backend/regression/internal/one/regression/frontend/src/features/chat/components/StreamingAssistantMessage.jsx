      ...
      <div className="mb-8 last:mb-0">
        ...
        {webSearchStatus && (
          <div className="px-4 mb-3">
            <div className="flex items-center gap-2 text-sm text-text-300">
              <Sparkles size={16} className="text-accent-main-100 animate-spin" />
        ...
        <div className="px-4">
          <div className="flex items-start gap-3 pt-1">
            ...
            {/* 답변 생성 중 텍스트 또는 실제 답변 (웹검색 상태가 없을 때만) */}
            {propIsStreaming && !displayText && !webSearchStatus ? (
