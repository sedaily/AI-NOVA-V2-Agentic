...
const BasicNProGuideSection = ({ selectedEngine = "11" }) => {
  return (
    <div className="w-full max-w-4xl pt-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-text-300 leading-relaxed">
          {selectedEngine === "11"
            ? "기업 홍보·IR·제품 출시·인사 발표 등 기업 보도자료 작성 서비스"
            : "정부 정책·공공기관·지자체 보도자료 작성 서비스"}
        </p>
      </div>
        ...
        >
          ...
          <div>
            <p className="text-sm text-text-200 leading-relaxed">
              <span className="font-medium">시작하는 방법:</span> 입력창에 보도자료
        ...
        >
          ...
          <div>
            <p className="text-sm text-text-200 leading-relaxed">
              ...
              {selectedEngine === "11"
                ? "기업 보도자료 형식·톤앤매너·전문 용어 최적화"
                : "정부/공공 보도자료 형식·공식 문체·정책 용어 최적화"}
            </p>
          </div>
        </div>
      </div>
