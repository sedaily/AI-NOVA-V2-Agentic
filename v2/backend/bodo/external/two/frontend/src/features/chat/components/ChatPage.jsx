    ...
    const handleWebSocketMessage = (message) => {
      ...
      switch (message.type) {
        ...
        case "ai_start":
          ...
          // 🌐 웹검색 결과 캡처 (AI 메시지에 첨부하기 위해)
          const currentWebSearchResults = webSearchResults;
          if (currentWebSearchResults) {
            console.log("🌐 웹검색 결과를 AI 메시지에 첨부:", currentWebSearchResults.sources?.length, "개 출처");
          }
          ...
          setMessages((prev) => {
            const newMessages = [
              ...prev,
              {
                ...
                timestamp: new Date(),
                isStreaming: true,
                webSearchResults: currentWebSearchResults, // 🌐 웹검색 결과 첨부
              },
            ];
                ...
                <div className="flex gap-2.5 w-full items-center">
                  <div className="relative flex-1 flex items-center gap-2 shrink min-w-0">
                    ...
                    <div className="relative shrink-0">
                      <button
                        onClick={() => {
                          ...
                          console.log('🌐 웹검색 토글:', !webSearchEnabled);
                        }}
                        className={clsx(
                    ...
                    <div className="relative shrink-0 model-dropdown">
                      ...
                      {/* Dropdown Menu - 위로 펼침 (입력창이 하단에 있으므로) */}
                      {isModelDropdownOpen && (
                        <div
