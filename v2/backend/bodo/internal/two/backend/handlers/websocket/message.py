...
def handler(event, context):
    ...
    try:
        ...
        # 메시지 전송 액션
            ...
            model_id = body.get('modelId') or body.get('model_id', 'claude-opus-4-5-20251101')

            logger.info(f"Processing message for {engine_type}, user: {user_id}, role: {user_role}, model: {model_id}")
