...
def stream_claude_response_enhanced(
    ...
    """
    try:
        # 모델 ID 매핑 (Bedrock 모델 ID 형식)
        model_mapping = {
            'claude-opus-4-6': 'us.anthropic.claude-opus-4-6-v1',  # Opus 4.6 (최신)
            'claude-opus-4-5-20251101': 'us.anthropic.claude-opus-4-5-20251101-v1:0',  # Opus 4.5 (최신)
            'claude-opus-4-20250514': 'us.anthropic.claude-opus-4-20250514-v1:0',      # Opus 4.0
            'claude-sonnet-4-5-20241022': 'us.anthropic.claude-sonnet-4-5-20241022-v2:0',  # Sonnet 4.5
            'claude-sonnet-4-20250514': 'us.anthropic.claude-sonnet-4-20250514-v1:0'   # Sonnet 4.0
        }
        
        model_id = model_mapping.get(selected_model, CLAUDE_MODEL_ID)
        logger.info(f"Using Bedrock model: {model_id} (selected: {selected_model})")
