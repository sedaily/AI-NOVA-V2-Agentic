# Foreign (f1-two) Backend Deployment Script - PowerShell
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "   Foreign Backend Deployment" -ForegroundColor Cyan
Write-Host "   Target: f1-two Lambda Functions" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan

$REGION = "us-east-1"
$BACKEND_DIR = "$PSScriptRoot\backend"
$TEMP_DIR = "$env:TEMP\lambda-deploy-foreign"
