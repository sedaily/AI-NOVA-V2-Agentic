    ...
    def search(
        ...
        try:
            ...
            if system_prompt:
                ...
                messages.append({
                    "role": "system",
                    "content": "You are a helpful research assistant for Korean news. Search for the most recent and relevant information. Focus on factual, up-to-date content. Always respond in Korean."
                })
