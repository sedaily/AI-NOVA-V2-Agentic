...
Infrastructure Version: Production v3.3
...
| Bucket Name                    | Purpose             | Public Access | Website Hosting | Region         |
| ------------------------------ | ------------------- | ------------- | --------------- | -------------- |
| `nexus-multi-frontend-20251204` | Production Frontend | Public Read   | Enabled         | ap-northeast-2 |

### 5. CloudFront Distributions

| Distribution ID  | Domain Name                   | Origin                                                              | Comment                    |
| ---------------- | ----------------------------- | ------------------------------------------------------------------- | -------------------------- |
| `E1O9OA8UA34Z49` | d1zig3y52jaq1s.cloudfront.net | nexus-multi-frontend-20251204.s3-website.ap-northeast-2.amazonaws.com | Production (Internal PROOF) |

### 6. Secrets Manager

| Secret Name                | Description                        | Region    | Usage                      |
| -------------------------- | ---------------------------------- | --------- | -------------------------- |
| `proof-v1`                 | Anthropic API Key for Proofreading | us-east-1 | Primary AI Service         |
| `nexus/perplexity-api-key` | Perplexity API Key for Web Search  | us-east-1 | Real-time Web Search (Sonar) |
  ...
  "Statement": [
    {
      ...
      "Resource": [
        "arn:aws:secretsmanager:us-east-1:887078546492:secret:proof-v1*",
        "arn:aws:secretsmanager:us-east-1:*:secret:nexus/perplexity-api-key*"
      ]
    }
  ]
}
...
| ---------- | ------- | ------------------------------------------ | ---------------- |
| 2026-01-24 | 3.3     | Fix S3/CloudFront info, add Perplexity secret | Claude Code   |
...
- [docs/WEB_SEARCH_IMPLEMENTATION.md](./docs/WEB_SEARCH_IMPLEMENTATION.md) - Web search feature implementation guide
