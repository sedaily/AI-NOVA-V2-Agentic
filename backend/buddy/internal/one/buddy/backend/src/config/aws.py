...
BEDROCK_CONFIG = {
    ...
    'opus_model_id': os.environ.get('BEDROCK_OPUS_MODEL_ID', 'us.anthropic.claude-opus-4-6-v1'),
...
DYNAMODB_TABLES = {
    ...
    'prompts': os.environ.get('PROMPTS_TABLE', 'b1-prompts-v2'),
    'files': os.environ.get('FILES_TABLE', 'b1-files-v2'),
