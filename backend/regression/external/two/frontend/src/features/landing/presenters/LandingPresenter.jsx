    ...
    <div className="min-h-screen overflow-x-hidden bg-[#0a0a0f]">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-[-10%] left-[20%] w-[500px] h-[500px] bg-emerald-600/10 rounded-full filter blur-[120px]" />
          <div className="absolute top-[20%] right-[10%] w-[400px] h-[400px] bg-teal-600/8 rounded-full filter blur-[100px]" />
          <div className="absolute bottom-[10%] left-[30%] w-[600px] h-[600px] bg-cyan-600/5 rounded-full filter blur-[150px]" />
        </div>
