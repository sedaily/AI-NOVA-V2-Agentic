# ============================================
# Nexus Foreign - ONE Frontend Deployment (PowerShell)
# ============================================
...
Write-Host "   Nexus Foreign - ONE Deployment" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "S3 Bucket: $S3_BUCKET" -ForegroundColor Gray
Write-Host "CloudFront ID: $DISTRIBUTION_ID" -ForegroundColor Gray
