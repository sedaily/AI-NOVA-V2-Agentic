...
echo -e "${BLUE}=================================${NC}"
echo -e "${BLUE}F1 FOREIGN LAMBDA DEPLOYMENT${NC}"
echo -e "${BLUE}=================================${NC}"
echo ""
...
# Lambda 함수 목록
FUNCTION_NAMES=(
    "${PREFIX}-conversation-api-two"
    "${PREFIX}-prompt-crud-two"
    "${PREFIX}-usage-handler-two"
    "${PREFIX}-websocket-message-two"
    "${PREFIX}-websocket-connect-two"
    "${PREFIX}-websocket-disconnect-two"
)
