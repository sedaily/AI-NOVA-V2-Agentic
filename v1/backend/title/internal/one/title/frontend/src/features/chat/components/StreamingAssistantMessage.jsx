...
const StreamingAssistantMessage = memo(
  ({
    ...
    sources,
    sourceTitle,
    webSearchStatus,      // 웹검색 상태 메시지
    webSearchResultsUI,   // 웹검색 결과 UI 컴포넌트
  }) => {
        ...
        <div className="px-4">
          <div className="flex items-start gap-3 pt-1">
            ...
            {propIsStreaming && !displayText ? (
              webSearchStatus ? (
                // 웹검색 중일 때 - AI가 말하는 것처럼
                <span className="text-sm text-text-300">{webSearchStatus}</span>
              ) : (
