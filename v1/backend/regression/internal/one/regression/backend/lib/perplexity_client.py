...
class PerplexityClient:
    ...
    def search_for_context(
        ...
        logger.info(f"웹검색 시작: '{display_query}' (오늘: {today})")

        system_prompt = f"""You are a helpful research assistant for Korean news.
Today's date is {today}. Search for the most recent and relevant information from 2026.
Focus on factual, up-to-date content. Always respond in Korean."""
