...
# Claude 모델 설정
DEFAULT_MODEL_ID = "anthropic.claude-opus-4-6-v1"  # Opus 4.6 기본값 (최신, 버전 번호 없음!)
...
BEDROCK_MODEL_MAP = {
    ...
    "opus-4-20250514": "anthropic.claude-opus-4-6-v1",  # 버전 번호 없음!
...
def stream_claude_response_enhanced(
    ...
    model_id: str = None  # 모델 ID 파라미터 추가
) -> Iterator[str]:
    """
