...
export const useChat = (initialMessage, selectedEngine = "11", initialSelectedModel = "claude-opus-4-5-20251101") => {
  ...
  }, [input, isLoading, messages, selectedEngine, selectedModel]);
