...
// Claude 모델 목록
const CLAUDE_MODELS = [
  { id: "claude-opus-4-5-20251101", name: "Opus 4.5", desc: "복잡한 작업에 최적" },
  { id: "claude-sonnet-4-5-20250929", name: "Sonnet 4.5", desc: "일상적 작업에 최고" },
  { id: "claude-haiku-4-5-20251001", name: "Haiku 4.5", desc: "빠른 답변에 최적" },
];
              ...
              <div className="relative flex-1 flex items-center gap-2 shrink min-w-0">
                ...
                {showModelSelector && (
                  <div className="relative shrink-0 model-dropdown" ref={modelDropdownRef}>
                    ...
                    {showModelDropdown && (
                      <div
                        className="absolute top-full mt-2 right-0 z-50 rounded-lg border shadow-lg"
                        style={{
                          minWidth: "200px",
