...
def handler(event, context):
    ...
    try:
        ...
        # 메시지 전송 액션
            ...
            selected_model = body.get('selectedModel', 'claude-opus-4-5-20251101')  # 프론트엔드에서 선택한 모델
            web_search_enabled = body.get('webSearchEnabled', False)  # 웹검색 활성화 여부 (기본값: False - 명시적 활성화 필요)
