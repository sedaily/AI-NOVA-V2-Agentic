...
# Claude 모델 설정 - 기본값
DEFAULT_MODEL_ID = BEDROCK_CONFIG['opus_model_id']
...
MODEL_ID_MAPPING = {
    'claude-opus-4-6': 'us.anthropic.claude-opus-4-6-v1',  # Opus 4.6 (최신, 2026-02-05 출시)
