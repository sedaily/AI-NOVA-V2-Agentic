...
class WebSocketService {
  ...
  sendMessage(
    ...
    idempotencyKey = null,
    selectedModel = 'claude-opus-4-5-20251101',  // NEW PARAMETER
    webSearchEnabled = false  // Web search parameter
  ) {
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        // Model selection - use parameter, fallback to localStorage, then default
        const modelToUse = selectedModel || localStorage.getItem('selectedModel') || 'claude-opus-4-5-20251101';
        ...
        if (messageChunks.length > 1) {
          ...
          messageChunks.forEach((chunk, index) => {
            const payload = {
              ...
              modelId: modelToUse,  // NEW FIELD
              webSearchEnabled: webSearchEnabled,  // Web search state
...
export const sendChatMessage = (
  ...
  webSocketService.sendMessage(
    ...
    conversationHistory,
    idempotencyKey,
    selectedModel,  // PASS MODEL TO SEND MESSAGE
